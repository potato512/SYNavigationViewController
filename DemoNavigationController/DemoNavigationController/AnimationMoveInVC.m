...
@interface AnimationMoveInVC ()

@end

@implementation AnimationMoveInVC
...
{
    [self.sy_navigationController navigationControllerAnimation:0.6 type:@"moveIn" subType:kCATransitionFromRight function:kCAMediaTimingFunctionLinear];
