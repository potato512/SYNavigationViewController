...
@interface AnimationRevealVC ()

@end

@implementation AnimationRevealVC
...
{
    [self.sy_navigationController navigationControllerAnimation:0.6 type:@"reveal" subType:kCATransitionFromRight function:kCAMediaTimingFunctionLinear];
