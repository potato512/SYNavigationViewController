...
@interface AnimationSuckVC ()

@end

@implementation AnimationSuckVC
...
{
    [self.sy_navigationController navigationControllerAnimation:0.6 type:@"suckEffect" subType:kCATransitionFromRight function:kCAMediaTimingFunctionLinear];
