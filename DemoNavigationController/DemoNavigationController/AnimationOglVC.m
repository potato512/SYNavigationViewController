...
@interface AnimationOglVC ()

@end

@implementation AnimationOglVC
...
{
    [self.sy_navigationController navigationControllerAnimation:0.6 type:@"oglFlip" subType:kCATransitionFromRight function:kCAMediaTimingFunctionLinear];
