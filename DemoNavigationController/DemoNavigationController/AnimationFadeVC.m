...
@interface AnimationFadeVC ()

@end

@implementation AnimationFadeVC
...
{
    [self.sy_navigationController navigationControllerAnimation:0.6 type:@"fade" subType:kCATransitionFromRight function:kCAMediaTimingFunctionLinear];
