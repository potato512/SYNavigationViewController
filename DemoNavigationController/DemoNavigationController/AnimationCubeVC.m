...
@interface AnimationCubeVC ()

@end

@implementation AnimationCubeVC
...
{
    [self.sy_navigationController navigationControllerAnimation:0.6 type:@"cube" subType:kCATransitionFromRight function:kCAMediaTimingFunctionLinear];
